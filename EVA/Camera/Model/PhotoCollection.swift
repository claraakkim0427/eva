...
class PhotoCollection: NSObject, ObservableObject {
    ...
    func addImage(_ imageData: Data,fileURL:URL?=nil,israw:Bool=false) async throws {
...
//                jpegOptions.uniformTypeIdentifier = "public.jpeg"  // For JPEG
                if let assetPlaceholder = creationRequest.placeholderForCreatedAsset {
                    
                    if (fileURL != nil && israw) {
                        ...
                        creationRequest.addResource(with: .photo, data: imageData, options: jpegOptions)
                    }
...
fileprivate let logger = Logger(subsystem: "com.kaiagao.EVA", category: "PhotoCollection")
